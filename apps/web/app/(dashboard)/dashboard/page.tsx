        ...
        <div className="card p-6 lg:col-span-2">
          ...
          {recentIncidents.length === 0 ? (
            <p className="py-8 text-center text-sm text-muted-foreground">
              ...
              <a href={`${process.env.NEXT_PUBLIC_DEMO_URL ?? 'https://chronicle-app-demo.vercel.app'}/demo`} className="text-primary hover:underline">ShopFlow Demo</a>
            </p>
          ) : (
        ...
        <div className="card p-6">
          ...
          <div className="space-y-1">
            {[
              ...
              { label: 'Demo Chaos Panel', href: `${process.env.NEXT_PUBLIC_DEMO_URL ?? 'https://chronicle-app-demo.vercel.app'}/demo`, external: true },
            ].map((a) => (
              <Link
                key={a.label}
                href={a.href}
